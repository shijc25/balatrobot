...
jokers = [
    Joker(name="Even Steven",index=39,value=4,rarity=0,state={},rank_affinity=[2, 4, 6, 8, 10],),
    Joker(name="Odd Todd",index=40,value=4,rarity=0,state={},rank_affinity=[3, 5, 7, 9, 14],),
    Joker(name="Greedy Joker",index=2,value=5,rarity=0,state={},suit_affinity=["Diamonds"],),
    Joker(name="Lusty Joker",index=3,value=5,rarity=0,state={},suit_affinity=["Hearts"],),
    Joker(name="Wrathful Joker",index=4,value=5,rarity=0,state={},suit_affinity=["Spades"],),
    Joker(name="Gluttonous Joker",index=5,value=5,rarity=0,state={},suit_affinity=["Clubs"],),
    Joker(name="Fibonacci",index=31,value=8,rarity=1,state={},rank_affinity=[14, 2, 3, 5, 8],),
    Joker(name="Scholar", index=41, value=4, rarity=0, state={}, rank_affinity=[14]),
    Joker(name="Scary Face",index=33,value=4,rarity=0,state={},rank_affinity=[11, 12, 13],),
    Joker(name="Walkie Talkie",index=101,value=4,rarity=0,state={},rank_affinity=[10, 4],),
    Joker(name="Smiley Face",index=104,value=4,rarity=0,state={},rank_affinity=[11, 12, 13],),
    Joker(name="Joker", index=1, value=2, rarity=0, state={}),
    Joker(name="Jolly Joker",index=6,value=3,rarity=0,state={}),
    ...
    # Joker(name="Yorick",index=148,value=20,rarity=3,state={"mult_mult": 1, "discards_left": 23},),
