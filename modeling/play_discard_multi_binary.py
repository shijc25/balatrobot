...
class PlayDiscardBinaryDist(TorchDistributionWrapper):
    ...
    def sample(self):
        print("PlayDiscardBinaryDist.sample() called")
        self.sample_was_called = True
        mode_dist = self.mode_distribution()
